...
//console.log(myDeck.hand1.length)
//console.log('BEFORE WARPILE', myDeck.hand1, myDeck.hand2)
for (let i = 0; i <= 10; i++) {
  count++;
  ...
  //console.log('AFTER WARPILE', myDeck.hand1, myDeck.hand2)
  console.log(myDeck.warPile)
  if (p1.score > p2.score) {
    console.log(`Player 1 plays ${p1.rank} of ${p1.suit} and takes the win versus ${p2.rank} of ${p2.suit}`)
    //console.log(myDeck.hand1[0], myDeck.hand2[0])
    myDeck.hand1.push(...myDeck.warPile)
    // console.log('AFTER COLLECTING WARPILE', myDeck.hand1, myDeck.hand2)
